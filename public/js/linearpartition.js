app.service('linearPartition', function() {
    ...
    this.run = function (seq, k) {
        ...
        var dividers = [];
        var sums = this.prefix_sums(sequence, k);
        var conds = this.boundary_conditions(sequence, k, sums);
        ...
        return(this.reconstruct_partition(sequence, dividers, k));
    };
     ...
     * the partitions. */
    this.reconstruct_partition = function(seq, dividers, k) {
        var partitions = [];
    ...
    */
    ...
    this.boundary_conditions = function(seq, k, sums) {
        var conds = [];
